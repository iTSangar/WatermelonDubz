...
- (void)updateLabelValues {
    ...
    if (self.numberStringOverride != nil) {
        self.maxLabel.string = _numberStringOverride;
        return;
    }
...
-(void)setStringFormatterOverride:(NSString *)stringFormatterOverride{
    _numberStringOverride = stringFormatterOverride;
    [self updateLabelValues];
}
